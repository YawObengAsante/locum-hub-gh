import {
  DashboardJobsLoadingSkeleton,
  DashboardProfileLoadingSkeleton,
...
export default async function DashboardPage() {
  ...
  return (
    <div>
      <Suspense fallback={<DashboardProfileLoadingSkeleton />}>
        <ProfileHeader userId={userId} />
      </Suspense>
      
      <Suspense fallback={<DashboardJobsLoadingSkeleton />}>
